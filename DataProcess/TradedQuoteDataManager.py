...
class TradedQuoteDataManager:
    def __init__(self, config_file_path: str):
        ...
        self.config_dict: dict = self.load_config(config_file_path)
        self.root_system: str = self.config_dict.get('root_system')
        self.quote_folder_name: str = self.config_dict.get('quote_folder_name')
        self.quote_reader_dict: dict[
            (str, int, int,
             int), TradedQuoteReader] = {}  # key: root, date, expiration, quote_manager_id; value: TradedQuoteReader
