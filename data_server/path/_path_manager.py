...
from ..utils._generate_pathes import get_stock_quote_path, get_stock_traded_quote_path, get_option_quote_path, get_option_traded_quote_path
        ...
        try:
            match domain:= domain_iterator.__next__():
                case AssetDomain.EQUITY:
                    return PathManager._match_equity_domain(domain_iterator, **kwargs)
                case _:
    ...
    def _match_stock_domain(domain_iterator, **kwargs) -> Path:
        match domain:= domain_iterator.__next__():
            case PriceDomain.TRADED:
                return get_stock_traded_quote_path(**kwargs)
