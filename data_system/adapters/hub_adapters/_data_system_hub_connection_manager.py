...
from data_system import DataSession
from data_system.session import MarketDataSessionFactory
...
class MarketDataSystemHubConnectionManger:
    ...
    def __init__(self):
        self._market_data_sessions: Dict[
            str, DataSession
        ] = dict()  # key: market_data_session_id, value: MarketDataSession
        self._hub_id_to_data_session_id: Dict[
            str, str
        ] = dict()  # key: hub_id, value: data_session_id

    def create_data_session(self, hub_id: str, operation_mode: OperationMode):
        data_session = MarketDataSessionFactory.create_data_session(
    ...
    def find_data_session(
        self, hub_id: Optional[str] = None, data_session_id: Optional[str] = None
    ) -> None | DataSession:
