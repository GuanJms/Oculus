...
from data_system.backtest_simulation._backtest_data_session_factory import (
    BacktestDataSessionFactory,
)
...
class BacktestDataManager:
    def __init__(self):
        ...
        self._backtest_data_session_dict: dict[
            str, BacktestDataSession
        ] = {}  # id: BacktestDataSession
