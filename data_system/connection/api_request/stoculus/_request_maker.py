...
class StoculusRequestMaker:
    ...
    def get_assets_connection_request(assets: list[Asset], date: int) -> dict:
        ...
        for asset in assets:
            request.update(
                StoculusRequestMaker.get_asset_connection_request(asset, date)
            )
        return request
    ...
    @staticmethod
    def get_read_upto_time_request(
        data_hub: "AssetDataHub", ms_of_day: int | float
    ) -> dict:
        read_request = {
    ...
    @staticmethod
    def get_option_exps_request(ticker: str):
        return {"ticker": ticker}

    @classmethod
    def get_option_strikes_request(cls, ticker: str, exp: int):
        return {"ticker": ticker, "exp": exp}
