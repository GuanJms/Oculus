...
class ExecutionManager:
    def __init__(
        ...
        self._execution_session_dict: dict[
            str, ExecutionSession
        ] = {}  # execution_session_id: ExecutionSession
    ...
    def get_execution_session(
        self, strategy_rule_instance: StrategyRule
    ...
    def _initialize_session(
        ...
        InitializationManager.initialize_backtest_data_session(
            backtest_data_session, time_params, expiration_params
        )
        execution_session = ExecutionSessionFactory.create_session(
            strategy_rule_instance, time_params, backtest_data_session
        )
        ...
        self._strategy_id_to_execution_session_id_dict[
            strategy_rule_instance.id
    ...
    def execute_strategy(self, strategy_rule_instance: StrategyRule):
        ...
        execution_session = self._initialize_session(
            strategy_rule_instance, backtest_data_session
        )
