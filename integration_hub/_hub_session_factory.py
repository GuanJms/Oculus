...
from integration_hub._hub_session import HubSession
...
class HubSessionFactory:
    ...
    def create(
        cls,
        hub_type: HubType,
        strategy_rule_cls: Type[StrategyRule] = None,
        ...
        match cls:
            case HubType.BACKTESTING:
                args = {
                    ...
                    "strategy_rule_cls": strategy_rule_cls,
                }
                check_attribute_exist(
                    attributes=["hub_type", "strategy_params", "strategy_rule_cls"],
                    args=args,
                )
