...
from market_data_system._enums import *
from market_data_system.security_basics import Stock, Asset
from market_data_system.security_basics.option_basics.core import Option
...
DOMAIN_ASSET_MAP = {
    AssetDomain.EQUITY: {
        EquityDomain.STOCK: Stock,
        EquityDomain.OPTION: Option
    }
}
...
class DomainMatcher:
    ...
    @staticmethod
    def match_domain_asset(domains: List[DomainEnum | AssetDomain], domain_map: dict = None, **kwargs):
        if domain_map is None:
