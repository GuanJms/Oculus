...
from strategics.repo.core.combo.option.basics.adhoc_combo_rule import AdhocComboRule
from strategics.repo.core.combo.combo_rule import ComboRule
from strategics.repo.core.combo.option.basics.iron_condor_rule import IronCondorRule
from strategics.repo.core.combo.option.basics.spread_combo_rule import CallSpreadRule, PutSpreadRule
...
class TestIronCondorCombo(unittest.TestCase):
    ...
    def test_iron_condor_init(self):
        ...
        self.assertEqual(1, delta_low_call_param['position_generation'])
        ...
        self.assertEqual(-1, delta_high_call_param['position_generation'])
        ...
        self.assertEqual(1, delta_low_put_param['position_generation'])
        ...
        self.assertEqual(-1, delta_high_put_param['position_generation'])
