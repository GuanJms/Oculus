...
class CalendarSpreadRule(ComboRule):
    def __init__(self, long_term_leg_rule: Rule, short_term_leg_rule: Rule):
        ...
        # Assuming both legs have the same position_generation size but opposite positions
        self.add_leg_rule(long_term_leg_rule, 1)  # Long position_generation
        self.add_leg_rule(short_term_leg_rule, -1)  # Short position_generation
