...
from strategy_module.combo_module.adhoc_combo_rule import AdhocComboRule
...
from strategy_module.combo_module.spread_combo_rule import CallSpreadRule, PutSpreadRule
