...
class SimulationTimelineManager(TimelineManager):
    ...
    def set_start_time(self, start_time: Union[int, str, timedelta]):
        self._start_ms_of_day = get_milliseconds(start_time)

    def set_end_time(self, end_time: Union[int, str, timedelta]):
